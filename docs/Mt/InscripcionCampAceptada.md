# InscripcionCampAceptada.vue

Este código implementa una plantilla de correo electrónico para informar al usuario que se ha aceptado su inscripción a un campeonato.
...
Contiene el mensaje destinado al atleta, indicando su usuario, el campeonato al que se inscribió y su aprobación.
