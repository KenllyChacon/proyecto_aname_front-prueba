# PagoAsociacionAceptado.vue

Este código implementa una plantilla de correo electrónico para informar al usuario que se ha aprobado su membresía a la federación seleccionada.
...
Contiene el mensaje destinado al atleta, indicando su usuario y el comprobante de pago.
...
export default {
  data() {
    return {
      pago: localStorage.getItem("pagoAcept"),
    };
  },
};
```
