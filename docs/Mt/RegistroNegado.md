...
Este código implementa una plantilla de correo electrónico para informar al usuario que se ha denegado su registro como atleta.
...
Contiene el mensaje destinado al atleta, indicando usuario y que se ha denegado su registro en la plataforma.

```html
<!--Contenido del mail-->
<div class="container" id="cuerpoMail">
  <p align="left">El registro del usuario {{ usuario }} ha sido denegado.</p>
  <p align="left">
    Esto puede deberse a que su información de registro no concuerda con su
    documento de identidad.
  </p>
  <p align="left">Por favor vuelva a registrarse.</p>
</div>
```
...
export default {
  data() {
    return {
      usuario: localStorage.getItem("emailNeg"),
    };
  },
};
```
