# PagoInscripcionAceptado.vue

Este código implementa una plantilla de correo electrónico para informar al usuario que se ha aceptado su pago de inscripción a un campeonato determinado.
...
<div class="container" id="cuerpoMail">
  <p align="left">
    Su pago de inscripción al campeonato {{ campeonato }} ha sido aprobado
  </p>
  <p align="left">
