...
const routes = [
  {
    ...
    name: "home",
    component: () =>
      import(/* webpackChunkName: "Inicio" */ "@/pages/Negocio/Inicio.vue"),
  },
  {
    path: "/about",
    name: "about",
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "UsuarioRegistrar" */ "@/pages/Negocio/UsuarioRegistrar.vue"
      ),
    meta: {
      requiresAuth: false,
      // roles: ['ADMIN']
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "crearCampeonato" */ "@/pages/Negocio/CrearCampeonato.vue"
      ),
    meta: {
      requiresAuth: true,
      roles: ["ADM", "JUN", "ORG"],
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "FichaInscripcion" */ "@/pages/Negocio/FichaInscripcion.vue"
      ),
    meta: {
      requiresAuth: true,
      //roles: ['ATL']
...

  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "AdmitirAtletas" */ "@/pages/Negocio/AdmitirAtletas.vue"
      ),
    meta: {
      requiresAuth: true,
      //roles: ["ADMIN"],
...

  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "AprobarInscripciones" */ "@/pages/Negocio/AprobarInscripciones.vue"
      ),
    meta: {
      requiresAuth: true,
      //roles: ['ADMIN']
...
router.beforeEach((to, from, next) => {
  ...
  if (to.path === "/registro") {
    ...
    isAuthenticated &&
    rolesRequired &&
    !rolesRequired.includes(sessionStorage.getItem("rol").toUpperCase())
  ) {
    next("/");
  } else if (!estado) {
    next("/login");
